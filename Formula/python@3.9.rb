class PythonAT39 < Formula
  ...
  url "https://www.python.org/ftp/python/3.9.0/Python-3.9.0b3.tar.xz"
  sha256 "af1d09f8f59d1329273c2970e3156e2f9949e5cd9c408264eba3ca84213c957f"
  ...
  skip_clean "bin/pip3", "bin/pip-3.9"
